...
import static seedu.docit.logic.commands.CommandTestUtil.INVALID_PATIENT_ID_DESC_MINUS_1;
...
import static seedu.docit.logic.commands.CommandTestUtil.VALID_PATIENT_ID_0;
import static seedu.docit.logic.commands.CommandTestUtil.VALID_PATIENT_ID_DESC_0;
...
public class AddAppointmentCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        LocalDateTime expectedDateTime = LocalDateTime.of(
            2021, 12, 21, 16, 0);
        Appointment expectedAppointment = new Appointment(SampleDataUtil.getSamplePatients()[0], expectedDateTime);
